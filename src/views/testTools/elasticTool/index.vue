        ...
        <el-row :gutter="20">
            <el-col :span="8">
                <div class="grid-content bg-purple">
                    <label class="radio-label">host: </label>
            <el-input v-model="jiraInput1" placeholder="请输入内容" style="width:225px;"></el-input>
                    <label class="radio-label">账号: </label>
            <el-input v-model="jiraInput2" placeholder="请输入内容" style="width:225px;"></el-input>
                    <label class="radio-label">密码: </label>
            <el-input v-model="jiraInput3" placeholder="请输入内容" style="width:225px;"></el-input>
                </div>
            </el-col>
            <el-col :span="12">
